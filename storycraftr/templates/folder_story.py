# List of files to create with folder, filename, and content
files_to_create = [
    # Chapters
    {
        "folder": "chapters",
    ...
    {
        "folder": "outline",
        "filename": "general_outline.md",
        "content": f"# General Outline\n\nThis is the general outline of the book.",
    },
    {
        "folder": "outline",
        "filename": "character_summary.md",
        "content": "# Character Summary\n\nSummary of the main characters goes here.",
    },
    {
        "folder": "outline",
        "filename": "plot_points.md",
        "content": "# Main Plot Points\n\nThe main plot points of the book are described here.",
    },
    {
        "folder": "outline",
        "filename": "chapter_synopsis.md",
    ...
    },
    {
        ...
        "content": "# Magic/Science System\n\nThe magic or science system of the world is detailed here.",
    },
    {
        "folder": "worldbuilding",
