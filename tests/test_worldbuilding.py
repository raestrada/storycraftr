...
def test_generate_geography(
    ...
    mock_exists.assert_called_once_with(
        os.path.join("my_book", "worldbuilding", "geography.md")
    )
    ...
    mock_save.assert_called_once_with(
        "my_book", "geography.md", "Geography", "Generated Geography Content"
    )
...
def test_generate_history(
    ...
    # Assertions
    mock_exists.assert_called_once_with(
        os.path.join("my_book", "worldbuilding", "history.md")
    )
    ...
    mock_save.assert_called_once_with(
        "my_book", "history.md", "History", "Generated History Content"
    )
...
def test_generate_culture(
    ...
    # Assertions
    mock_exists.assert_called_once_with(
        os.path.join("my_book", "worldbuilding", "culture.md")
    )
    mock_message.assert_called_once_with(
        thread_id="thread_id",
    ...
    mock_save.assert_called_once_with(
        "my_book", "culture.md", "Culture", "Generated Culture Content"
    )
...
@patch("os.path.exists")
@patch("storycraftr.worldbuilding.save_to_markdown")
def test_generate_magic_system(
    mock_save,
    mock_exists,
    mock_file_lines,
    mock_load_book_config,
    ...
    # Assertions
    mock_exists.assert_called_once_with(
        os.path.join("my_book", "worldbuilding", "magic_system.md")
    )
    mock_file_lines.assert_called_once_with(
        os.path.join("my_book", "worldbuilding", "magic_system.md")
    )
    ...
    mock_save.assert_called_once_with(
        ...
        "Generated Magic System Content",
    )
...
def test_generate_technology(
    ...
    # Assertions
    mock_exists.assert_called_once_with(
        os.path.join("my_book", "worldbuilding", "technology.md")
    )
    mock_message.assert_called_once_with(
        thread_id="thread_id",
    ...
    mock_save.assert_called_once_with(
        "my_book", "technology.md", "Technology", "Generated Technology Content"
    )
