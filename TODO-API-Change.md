...
| Task ID | Description                      | Key Actions                                                                                                                                                                                                                                                                                                    | Status   |
| :------ | :------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------- |
| **3.1** | **End-to-End Testing**           | Manually test the full user workflow using the `storycraftr chat` command. Validate against: <br> - OpenAI's API. <br> - A Mistral.ai compatible endpoint. <br> Ensure that context from the book is correctly retrieved and used in responses.                                                                | **Done** |
