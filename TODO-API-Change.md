...
| **2.4** | **Fix Critical Bugs in Chat CLI** | Based on code review: <br> - **Exception Handling**: Replace broad `except Exception` with specific exceptions in `chat` command. <br> - **State Management**: Correct history update order. Append user input to history _before_ the API call.                                                                                                                                                                                                                                                                                                                                                                                                                                                     | To Do    |
| **2.5** | **Improve Chat Logic**            | Based on code review: <br> - **Idempotent Ingestion**: Make `ingest_book_data` check if data is already ingested. <br> - **Response Formatting**: Re-add prompt instruction for Markdown formatting. <br> - **RAG Validation**: Add a check to validate that RAG retrieval found relevant context.                                                                                                                                                                                                                                                                                                                                                                                                   | To Do    |
